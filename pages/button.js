function button() {
  return (
    <>
      <div className="p-5">
        <div className="mb-7">
          <h2 className="font-bold">Default Button</h2>
          <button
            type="button"
        ...
        <div className="mb-10">
          <h1 className="font-bold">Button Pills</h1>
          <button
            type="button"
          ...
          <button
            type="button"
            className="mr-2 mb-2 rounded-full bg-yellow-400 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-yellow-500 focus:outline-none focus:ring-4 focus:ring-yellow-300 dark:focus:ring-yellow-900"
          >
            Yellow
          </button>
          <button
        ...
        <div className="mb-10">
          <h2 className="font-bold">Outline Button</h2>
          <button
            type="button"
            className="mr-2 mb-2 rounded-lg border-2 border-blue-700 px-5 py-2.5 text-sm font-medium text-blue-700 hover:bg-blue-800 hover:text-white focus:outline-none focus:ring-4 focus:ring-blue-300"
          >
            Default
          </button>
          <button
            type="button"
            className="mr-2 mb-2 rounded-lg border-2 border-black py-2.5 px-5 text-sm font-medium text-gray-900 hover:bg-black hover:text-white"
          >
            Dark
          </button>
          <button
            type="button"
            className="hover: mr-2 mb-2 rounded-lg border-2 border-green-600 px-5 py-2.5 text-sm font-medium text-green-600 hover:bg-green-600 hover:text-white"
          >
            Green
          </button>
          <button
            type="button"
            className="mr-2 mb-2 rounded-lg border-2 border-red-700 px-5 py-2.5 text-sm font-medium text-red-700 hover:bg-red-700 hover:text-white"
          >
            Red
          </button>
          <button
            type="button"
            className="mr-2 mb-2 rounded-lg border-2 border-yellow-400 px-5 py-2.5 text-sm font-medium text-yellow-400 hover:bg-yellow-400 hover:text-white"
          >
            Yellow
          </button>
          <button
            type="button"
            className="mb-2 rounded-lg border-2 border-purple-700 px-5 py-2.5 text-sm font-medium text-purple-700 hover:bg-purple-700 hover:text-white"
          >
            Purple
          </button>
        </div>
        <div className="mb-10">
          <h2 className="font-bold">Social Media Button</h2>
          <button
            type="button"
            className="dark:focus:ring-[#3b5998]/55 mr-2 mb-2 inline-flex items-center rounded-lg bg-[#3b5998] px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-[#3b5998]/90 focus:outline-none"
          >
            <svg
          ...
          <button
            type="button"
            className="dark:focus:ring-[#1da1f2]/55 mr-2 mb-2 inline-flex items-center rounded-lg bg-[#1da1f2] px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-[#1da1f2]/90 focus:outline-none"
          >
            <svg
              className="mr-2 -ml-1 h-4 w-4"
              aria-hidden="true"
          ...
          <button
            type="button"
            className="mr-2 mb-2 inline-flex items-center rounded-lg bg-[#24292F] px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-[#24292F]/90 focus:outline-none  dark:focus:ring-gray-500"
          >
            <svg
              className="mr-2 -ml-1 h-4 w-4"
              aria-hidden="true"
        ...
        <div className="mb-10">
          <h2 className="font-bold">Button Size</h2>
          <button
            type="button"
            className="rounded-lg bg-blue-700 px-3 py-2 text-center text-xs font-medium text-white hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300"
          >
            Extra small
          </button>
          <button
            type="button"
            className="rounded-lg bg-blue-700 px-3 py-2 text-center text-sm font-medium text-white hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300"
          >
            Small
          </button>
          <button
          ...
          <button
            type="button"
            className="rounded-lg bg-blue-700 px-5 py-3 text-center text-base font-medium text-white hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300"
          >
            Large
          </button>
          <button
            type="button"
            className="rounded-lg bg-blue-700 px-6 py-3.5 text-center text-base font-medium text-white hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300"
          >
            Extra large
          </button>
        </div>
        <div className="mb-10">
          <h2 className="font-bold">Button with Icon</h2>
          <button
            type="button"
        ...
        <div className="mb-10">
          <h2 className="font-bold">Icon Button</h2>
          <button
            type="button"
            className="mr-2 inline-flex items-center rounded-lg bg-blue-700 p-2.5 text-center text-sm font-medium text-white hover:bg-blue-800 focus:outline-none"
          >
            <svg
              className="h-5 w-5"
              fill="currentColor"
          ...
          <button
            type="button"
            className="mr-2 inline-flex items-center rounded-full bg-blue-700 p-2.5 text-center text-sm font-medium text-white hover:bg-blue-800 focus:outline-none"
          >
            <svg
              className="h-4 w-4"
              fill="currentColor"
          ...
          <button
            type="button"
            className="mr-2 inline-flex items-center rounded-lg border border-blue-700 p-2.5 text-center text-sm font-medium text-blue-700 hover:bg-blue-700 hover:text-white focus:outline-none"
          >
            <svg
              className="h-5 w-5"
              fill="currentColor"
          ...
          <button
            type="button"
            className="inline-flex items-center rounded-full border border-blue-700 p-2.5 text-center text-sm font-medium text-blue-700 hover:bg-blue-700 hover:text-white focus:outline-none"
          >
            <svg
              className="h-5 w-5"
              fill="currentColor"
        ...
        <div className="mb-10">
          <h2 className="font-bold">Disable Button</h2>
          <button
            type="button"
        ...
        <div className="mb-10">
          ...
          <button
            disabled
            type="button"
            className="mr-2 inline-flex items-center rounded-lg border border-gray-200 bg-white py-2.5 px-5 text-sm font-medium text-gray-900 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:text-blue-700 focus:outline-none focus:ring-4 focus:ring-blue-700 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white"
          >
            <svg
              role="status"
